...
set --global fzf_common_options --reverse --margin=1 --padding=1 --bind 'ctrl-space:toggle-preview' --color header:bright-yellow:bold --color=prompt:#00FF00 --style=minimal --info=inline
