...
-- Ctrl + Alt + B
----------------------------------------------------------------------------------
local browserimage = hs.image.imageFromURL("https://upload.wikimedia.org/wikipedia/commons/thumb/8/8d/Safari_2020_logo.svg/1920px-Safari_2020_logo.svg.png")
...
local vsWorkspaceLauncher = function(choice)
  if not choice then return end
  local shell_command = "open -n '/Applications/Visual Studio Code.app' --args " .. choice["subText"]  
  hs.execute(shell_command)
end

local vscodeImage = hs.image.imageFromURL("https://upload.wikimedia.org/wikipedia/commons/thumb/9/9a/Visual_Studio_Code_1.35_icon.svg/1024px-Visual_Studio_Code_1.35_icon.svg.png")
vsCodeList = AwernxChooser:init("V", "VS Code Workspaces", vscodeImage, workspaceItemLoader, vsWorkspaceLauncher)
...
local kanderImage = hs.image.imageFromURL("https://www.kander.ai/assets/Kander%20Logo.png")
local sillaraiImage = hs.image.imageFromURL("https://www.sillarai.com/images/sillarai_favicon.png")
...
githubRepos = AwernxChooser:init("G", "GitHub Repositories", githubImage, workspaceItemLoader, githubRepoLauncher)
...
function displayWiFiBanner(ssid)
  displayNetworkBanner("https://upload.wikimedia.org/wikipedia/commons/thumb/a/ae/WiFi_Logo.svg/1280px-WiFi_Logo.svg.png", "🟢 Connected to " .. hs.wifi.currentNetwork())
end
